...
if __name__=='__main__':
    os.environ.setdefault("DJANGO_SETTINGS_MODULE", "mysite_71.settings")
    import django
    django.setup()
    ...
    # 批量创建
    # # 有100个书籍对象
    objs = [models.Book(title="沙河{}".format(i)) for i in range(15)]
    # 在数据库中批量创建, 10次一提交
    models.Book.objects.bulk_create(objs,10)

    # objs = [models.Book(title="沙河{}".format(i+104)) for i in range(1000)]
